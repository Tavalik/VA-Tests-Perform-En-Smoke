...
Сценарий: Открытие формы обработки "Import report types from Microsoft Excel spreadsheets"
...
Сценарий: Открытие формы обработки "Set up access rights to report types and templates"
...
Сценарий: Открытие формы обработки "Intercompany documents adjustments"
